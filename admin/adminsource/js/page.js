function TablePage(id,size){  
   var $table = $(id);  
    ...
    var $pager = $("<div class='page'><a href='javascript:void(0)'><span id='Prev' style='margin-right:4px;'>« 上页</span></a></div>");  //分页div  
    ...
    //$table.trigger("repaginate");  
    var next=$("<a href='javascript:void(0)'><span id='Next'>下页 »</span></a>");  
    $pager.append(next);  
